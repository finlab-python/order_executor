...
class TestPositionFromReport(unittest.TestCase):
    def test_strategy1(self):
        ...
        report = sim(buy, resample="M", upload=False, position_limit=1/3,
                     fee_ratio=1.425/1000/3, stop_loss=0.08, trade_at_price='open', name='藏獒')
    ...
    def test_strategy2(self):
        ...
        report = sim(position, upload=False, stop_loss=0.2, take_profit=0.8,
                     position_limit=0.25, fee_ratio=1.425/1000*0.3, name="營收股價雙渦輪")
        check_action_and_position(report)
#
