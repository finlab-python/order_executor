...
class TestMasterlinkAccount(unittest.TestCase):
    ...
    def test_update_odd_lot_order(self) -> None:
        """測試更新委託單"""
        # 選擇一個測試用股票代碼和數量
        stock_id = "2330"
        quantity = 100
    ...
    def test_masterlink_order(self) -> None:
        """測試元富帳戶正常下單"""
        self._test_account(odd_lot=False)

    def test_masterlink_order_odd_lot(self) -> None:
        """測試元富帳戶零股下單"""
        self._test_account(odd_lot=True)

    def test_masterlink_update_price(self) -> None:
        """測試元富帳戶更新價格"""
        self._test_update_price(odd_lot=False)

    def test_masterlink_update_price_odd_lot(self) -> None:
        """測試元富帳戶零股更新價格"""
    ...
    def _test_account(self, odd_lot: bool = False) -> None:
        ...
        oe = OrderExecutor(
            Position({sid1: q_sid1, sid2: q_sid2}), account=self.masterlink_account
        )
