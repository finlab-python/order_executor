...
def create_mock_result(
    is_success: bool = True, data: Any = None, message: str | None = None
) -> Mock:
...
def create_mock_account_list() -> tuple[Mock, Mock]:
    """創建 mock 帳戶列表"""
    account = Mock()
...
class MockBuilder:
    ...
    @staticmethod
    def order_result(**kwargs: Any) -> Mock:
        """建構 OrderResult mock"""
        defaults = {
            "function_type": 0,
            "date": "2023/10/12",
    ...
    @staticmethod
    def bank_remain(**kwargs: Any) -> Mock:
        """建構 BankRemain mock"""
        defaults = {
            "branch_no": "6460",
            "account": "26",
    ...
    @staticmethod
    def unrealized_data(**kwargs: Any) -> Mock:
